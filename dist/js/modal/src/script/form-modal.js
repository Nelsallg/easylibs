define(["require", "exports", "../components/animations/animation", "../functions/convert-type"], function (require, exports, animation_1, convert_type_1) {
    "use strict";
    ...
    class FormModal {
        init() {
            ...
            (0, convert_type_1.processNodes)(modals, (modal) => {
                var _a;
                this.modal = modal;
