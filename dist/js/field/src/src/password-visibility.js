define(["require", "exports", "../functions/convert-type", "../functions/utils"], function (require, exports, convert_type_1, utils_1) {
    "use strict";
    ...
    class PasswordVisibility {
        constructor(iconPath, showIconsToClick = false) {
            this.active = () => {
                ...
                (0, convert_type_1.processNodes)(fieldContainer, (container) => {
        ...
        iconStyle(html) {
            ...
            html.innerHTML = "";
            (0, convert_type_1.processNodes)(svg, (iconSvg) => {
                const style = {
                    color: '#999',
                    cursor: 'pointer',
                    width: '1.5rem',
...
//# sourceMappingURL=password-visibility.js.map