...
define(["require", "exports", "./fetch-request", "../functions/data-transfomer", "../functions/utils"], function (require, exports, fetch_request_1, data_transfomer_1, utils_1) {
    "use strict";
    ...
    class ProcessBackend {
        ...
        persist(redirectURL, callback = (result) => { }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                new fetch_request_1.FetchRequest({
                    uri: this._uri,
                    data: formData,
