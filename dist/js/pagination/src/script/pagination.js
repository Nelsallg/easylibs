...
define(["require", "exports", "../components/flash", "../modules/fetch-request", "./convert-type", "./dom", "./scroll-behavior"], function (require, exports, flash_1, fetch_request_1, convert_type_1, dom_1, scroll_behavior_1) {
    "use strict";
        ...
        (0, scroll_behavior_1.isEndScrolling)(element, (is, scroll) => {
            if (element && is) {
                ...
                if (nextPageNumber &&
                    ...
                    const request = new fetch_request_1.FetchRequest({
                        uri,
                        data: {
