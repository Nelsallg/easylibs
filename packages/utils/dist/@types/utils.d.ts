...
export default class Utils {
     ...
     */
    setAudio(audioPath: string, classname?: any): HTMLAudioElement;
    textToHTMLElement(textHtml: string, targetName?: string, children?: boolean): Element | HTMLCollection | null;
    /**
     * retourne un élément du dom
     */
    $$(element: Element | HTMLCollection | string): Element | HTMLCollection | NodeListOf<Element>;
    /**
     ...
     * @returns
     */
    processNodes(nodeList: any, callback?: (node: any, index?: number) => void): void;
    /**
     ...
     */
    getRegexp(type: RegexType): RegExp;
    /**
     ...
     */
    reduceText(text: string, maxLength?: number): string;
    /**
     ...
     */
    changeInputTextTypeToNumberType(attr: string, limit?: number | null, priceType?: boolean, decimal?: number): void;
    /**
     ...
     */
    disablor(tag?: string, target?: HTMLElement, trigger?: HTMLElement, backgroundColor?: string): void;
    /**
     ...
     */
    setAsteriskToRequiredField(): void;
    /**
     ...
     */
    hasKeyWithNameSubstring(object: any, substring: string, getKey?: boolean): any;
    /**
     ...
     * @returns The value or key of the first matching property if found, otherwise false.
     */
    findObjectDataByKeyName(object: any, keyOrShorKey: string, key?: boolean): boolean;
    findChar(string: string, limit: number, returnBool?: boolean): string | boolean;
    findComputedStyle(element: HTMLElement, property: string | Array<string>): any;
    /**
     ...
     */
    findHTMLElementBy(referent: HTMLElement, target: string): Element | null;
    /**
     ...
     */
    formatHTMLAttributes(attributes: any): string;
}
export {};
