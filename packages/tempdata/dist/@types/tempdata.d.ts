export default class TempData {
     ...
     */
    add(data: Record<string, any> | Array<Record<string, any>>): Promise<Record<string, any>>;
    /**
     ...
     */
    readOne(i: number, type?: "form-data" | "record"): Promise<FormData | Record<string, any> | undefined>;
    /**
     ...
     */
    readOneBy(criteria: Record<string, any>, type?: "form-data" | "record"): Promise<FormData | Record<string, any> | undefined>;
    /**
     ...
     */
    read(): Promise<Array<Record<string, any>>>;
    /**
     ...
     */
    readBy(criteria: Record<string, any>): Promise<Array<Record<string, any>>>;
    /**
     ...
     */
    deleteOne(id: number, refactoringShortKeyString?: string | null): Promise<boolean>;
    /**
     ...
     */
    refactorIndexes(refactoringShortKeyString?: string): Promise<any>;
    /**
