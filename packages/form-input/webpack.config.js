...
module.exports = {
  ...
  entry: {
    'form-input': './src/form-input.ts',
    // 'form-input-runner': './src/scripts/form-input-runner.ts',
    // 'icon': './src/scripts/icon.ts',
    // 'iform-input': './src/scripts/iform-input.ts',
    // 'styleTs': './src/scripts/style.ts',
    // 'form-input-style': './src/assets/scss/form-input-style.scss',
