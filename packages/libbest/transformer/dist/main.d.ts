/**
 * Interface exposée pour la transformation des blobs.
 */
export interface IBlobTransformer {
    /**
...
/**
 * Interface exposée pour la transformation des FormData.
 */
export interface IFormDataTransformer {
    /**
...
/**
 * Interface exposée pour la transformation des données en base64.
 */
export interface IBase64Transformer {
    /**
...
/**
 * Interface exposée pour la transformation de fichiers.
 */
export interface IFileTransformer {
    /**
